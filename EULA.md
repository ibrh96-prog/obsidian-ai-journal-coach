# End User License Agreement — AI Journal Coach

Last updated: June 2026

## 1. Acceptance

By purchasing, downloading, or using AI Journal Coach ("the Plugin"), you agree to this agreement. If you do not agree, do not use the Plugin.
...
The Plugin processes your journal notes locally. Notes are transmitted only to the AI provider you configure (Anthropic, OpenAI, OpenRouter, or a custom endpoint). The Plugin does not collect, store, or transmit any data to the developer.
